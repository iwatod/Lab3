...
Column( modifier = modifier.verticalScroll(rememberScrollState())) {
    BookImage(R.drawable.advanced_architecture_android, R.string.one )
    BookImage(R.drawable.kotlin_aprentice, R.string.two)
    BookImage(R.drawable.kotlin_coroutines, R.string.three)
}
}
